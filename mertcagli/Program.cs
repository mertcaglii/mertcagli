        ...
        static void Main(string[] args)
        {
            ...
            switch (seviye)
            {
                case 1:
                    ...
                    Console.WriteLine("Seviye 1'e Hoşgeldiniz 1 ile 10 Arasında Sayı Giriniz Ama 6 Hakkınız Bulunmaktadır ! ");
                    int hak = 6;
                Basadon:
                    Console.Write("Bir Tahmin Yazınız:");
                    int tahmin = Convert.ToInt32(Console.ReadLine());
                    if (tahmin == rastgelesayi)
                    {
                        Console.Write("Tebrikler... puan:{0}", hak * 15);
                    }
                    else if (tahmin < rastgelesayi)
                    {
                        ...
                        if (hak == 0)
                        {
                            Console.Write("Kaybettiniz! Hak Bitti Dogru cevap = :{0}", rastgelesayi);
                        }
                        else
                        {
                    ...
                    else if (tahmin > rastgelesayi)
                    {
                        ...
                        if (hak == 0)
                        {
                            Console.Write("Kaybettiniz! Hakkınız Bitti. Dogru cevap = :{0}", rastgelesayi);
                        }
                        else
                        {
